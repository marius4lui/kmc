...
import { Back, deleteCommand, editCommand, importScreen, mainMenu, runGroupedPicker, saveCommand, settingsMenu, validateScreen } from "./ui.js";
...
async function openInteractiveMenu() {
  ...
  while (true) {
    try {
      ...
      if (action === "validate") await validateScreen(config, settings);
