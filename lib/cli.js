...
import { Back, deleteCommand, devUrlsMenu, editCommand, importScreen, mainMenu, manageMenu, runGroupedPicker, saveCommand, scriptsMenu, settingsMenu } from "./ui.js";
...
async function openInteractiveMenu() {
  ...
  while (true) {
    try {
      ...
      if (action === "scripts") await scriptsMenu();
